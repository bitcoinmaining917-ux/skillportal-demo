...
export class Backend implements backendInterface {
    ...
    async getAllTrainees(): Promise<Array<TraineeRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTrainees();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async searchMarksheet(arg0: string, arg1: string, arg2: string): Promise<Array<TraineeRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchMarksheet(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
